...
public class ToDoDashResponse {
    ...
    @Builder
    public ToDoDashResponse(boolean myToDo, Long userId, String createUser, List<progressTodo> progressTodo, List<completionTodo> completionTodo) {
        this.myToDo = myToDo;
        this.userId = userId;
